...
{
	if (
		isset($_SESSION['cms_auth']) && 
		isset($_SESSION['cms_auth']['id']) && filter_var($_SESSION['cms_auth']['id'], FILTER_VALIDATE_INT) &&
		isset($_SESSION['cms_auth']['gid']) && filter_var($_SESSION['cms_auth']['gid'], FILTER_VALIDATE_INT) &&
		isset($_SESSION['cms_auth']['sess']) && (strlen($_SESSION['cms_auth']['sess']) == 32)
	) return TRUE;
...
$config['LicenseKey']	= 'NJ060000C00VY000000000000E0';
