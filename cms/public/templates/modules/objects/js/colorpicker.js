...
(function($, version)
{
      ...
      return this.each(
        function()
        {
          ...
          if (settings.window.expandable)
            $($this).after('<span class="jPicker"><span class="Icon"><span class="Color">&nbsp;</span><span class="Alpha">&nbsp;</span><span class="Image" title="Выбор цвета">&nbsp;</span><span class="Container">&nbsp;</span></span></span>');
  ...
  $.fn.jPicker.defaults = /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
      ...
      images:
        {
          clientPath: '/cms/images/colorpicker/', /* Path to image files */
          colorMap:
          {
            width: 256,
            height: 256,
      ...
      localization: /* alter these to change the text presented by the picker (e.g. different language) */
        {
          ...
          tooltips:
          {
            colors:
            {
              newColor: 'Новый цвет - Нажмите &ldquo;OK&rdquo; To Commit',
              currentColor: 'Щелкните чтобы сменить основной цвет'
            },
            buttons:
            {
              ok: 'Отправить этот цвет в выбранный',
              cancel: 'Отменить и заменить основной цвет'
            },
            hue:
            {
              radio: 'Выбор &ldquo;Hue&rdquo;',
              textbox: 'Введите &ldquo;Hue&rdquo; значение (0-360&deg;)'
            },
            saturation:
            {
              radio: 'Выбор &ldquo;Saturation&rdquo;',
              textbox: 'Введите &ldquo;Saturation&rdquo; значение (0-100%)'
            },
            value:
            {
              radio: 'Выбор &ldquo;Value&rdquo;',
              textbox: 'Введите &ldquo;Value&rdquo; значение (0-100%)'
            },
            red:
            {
              radio: 'Выбор &ldquo;Red&rdquo;',
              textbox: 'Введите &ldquo;Red&rdquo; значение (0-255)'
            },
            green:
            {
              radio: 'Выбор &ldquo;Green&rdquo;',
              textbox: 'Введите &ldquo;Green&rdquo; значение (0-255)'
            },
            blue:
            {
              radio: 'Выбор &ldquo;Blue&rdquo;',
              textbox: 'Введите &ldquo;Blue&rdquo; значение (0-255)'
            },
            alpha:
            {
              radio: 'Выбор &ldquo;Alpha&rdquo;',
              textbox: 'Введите &ldquo;Alpha&rdquo; значение (0-100)'
            },
            hex:
            {
              textbox: 'Введите &ldquo;Hex&rdquo; значение (#000000-#ffffff)',
              alpha: 'Введите &ldquo;Alpha&rdquo; значение (#00-#ff)'
            }
          }
        }
    };
